...
-- cashier.lua
-- Helper program to issue Arcade Credit Cards (Floppy Disks)
...
local function main()
    while true do
        ...
        print("Insert a floppy disk to issue/edit card...")
        
        while not drive.isDiskPresent() do
            os.pullEvent("disk")
        end
        
        sleep(0.5) -- Wait for mount
        ...
        write("Enter Credits: ")
        local credits = tonumber(read()) or 100
